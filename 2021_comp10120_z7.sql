...
--
-- Host: localhost:3306
-- Generation Time: Feb 25, 2022 at 07:13 PM
...
INSERT INTO `user_info` (`user_id`, `username`, `firstname`, `lastname`, `hashed_password`, `email_address`, `phone_number`, `nationality`, `course`, `accommodation`, `biography`, `private`) VALUES
(1, 'will', 'will', 'asbery', '$2y$10$EftjUdsv6E.91dx.HrbJE.NkFFy6XkkLUdkNcn8cIxFdjPvuuW5em', 'willasbery@gmail.com', '+44785812313', 'british', '', '', 'Hi, my name is Will and I study Computer Science at the University of Manchester. I am testing the software.', 0),
(2, 'admin', 'admin', 'admin', '$2y$10$a0OYu2O/J.GWVgw3XKYNDeN9li5kfbVXGFNOnDgJfFx7NAWWotpli', 'admin@gmail.com', '', 'afghan', '', '', '', 0),
(4, 'euan', NULL, NULL, '$2y$10$aVpORXJuR4Js80lwiJThaedmYAcF/VED86TkZ3iZZFqobg6dY7ejy', 'euan@gmail.com', NULL, NULL, NULL, NULL, NULL, 0);
